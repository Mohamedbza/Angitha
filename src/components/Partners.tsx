      ...
      <div className="container mx-auto px-4">
        ...
        <ScrollAnimation animation="zoomIn" delay={0.5}>
          <div className="relative overflow-hidden">
                         <div className="grid grid-cols-2 md:grid-cols-4 lg:flex lg:items-center lg:justify-center lg:space-x-16 gap-6 md:gap-8 justify-items-center">
              {partners.map((partner, index) => (
                ...
                >
                  <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center relative p-1">
                    <motion.div
